...
//    TestPrintHelper(std::variant< TestPrintHelper, std::pair<Keys, Values> >&&... args) :
//        stream({ to_json(std::move(args)) }, ...) {}
//
//private:
//    template<typename Key, typename Value>
//    static auto to_json(std::pair<Key, Value>&& arg) {
//        return nlohmann::json(std::move(arg.first), std::move(arg.second));
//    }
//
//    static auto to_json(std::pair<Key, Value>) {
//        return nlohmann::json(std::move(args.first), std::move(args.second));
//    }
//
...
//template<class T>
//TestPrintHelper test_print_helper(T const& value);
//
//template<class T>
//std::ostream& operator<<(std::ostream& stream,  T const& value) {
//    auto const values = test_print_herlper(value);
//
//    return stream;
//}
...
//template< class T >
//std::wstring test_print_helper(T const& value) {
//    return std::to_wstring(value);
//}
//
//template< size_t N >
//std::wstring test_print_helper(char const (& value)[N]) {
//    return widen_string(value);
//}
//
//std::wstring test_print_helper(char const * value) {
//    return widen_string(value);
//}
//
//template<>
//std::wstring test_print_helper(std::string_view const& value) {
//    return widen_string(std::string(value));
//}
...
//        //case 'e': return format_to(ctx.out(), "({:e}, {:e})", p.x, p.y);
//        //}
//        return format_to(ctx.out(), L"{}", magic_enum::enum_name(value));
//    }
//};
//
//}
...
std::vector<Corner> get_all_corners(OrientedPiece const& oriented_piece) {
    ...
    return std::move(corners) | ranges::to<std::vector>();
}
...
//
//        //boost::ut::printer::operator<<(narrow_string(test_print_helper(t)));
//
//        //using json = nlohmann::json;
//        //json const output = t;
//
//        //boost::ut::printer::operator<<(output.dump());
//
//        return *this;
//    }
//
